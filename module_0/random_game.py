...
# какой-то еще комментарий
def game_core_v3(number):
    # Алгоритм использует бинарный подход приближения к искомому числу:
...
def score_game(game_core):
    ...
    random_array = np.random.randint(1, 101, size=1000)    # создаем массив из случайных чисел

    for number in random_array:                     # для каждого загаданного числа ...
