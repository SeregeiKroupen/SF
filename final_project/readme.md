...
дважды подбирапясь к этой теме, удаляя часть дублей я необяъснимым образом для себя
сталкивался с ухудшением метрик ML-модели. Таким образом, я бросил эту затею.

Вторая неприятность - огромное количество ошибок и неточностей как в сопоствующей информации,
...
остальные содержали ее не полную или искаженную. Думаю, именно по-этому "простое" (на
...
как правило, не удалял его (только в стадлии моделирования - просто исключал), чтобы уже в конце 
...
того сколько из четырех ввещей присутствует в ваванной, чтобы столько четвертей и указываать для 
...
не недвижимость а вариант ренты или земля, не отсортированная по другим признакам.
В результате этой операции уже удалось получить значения метрики лучше:   
для МАРЕ вплоть до 1.06% (в подоавляющем большинстве - лучше 3%)  
для Pinball - даже еще лучше, "переоценка" составляла в среднем менее 2% 
...
этапе). ВЫшло, что в нескольких кластерах по мини мальному количеству записей - их 
